...
test("addition", function() {
  ...
  equal(5 * 3, result, "What is the value of result?");
});
...
test("assignment addition", function() {
  ...
  equal(1 * 15, result, "What is the value of result?");
});
...
test("assignment subtraction", function() {
  ...
  equal(2 * 1, result, "What is the value of result?");
});
...
test("modulus", function() {
  ...
  result %= x;
  equal(15 % 3, result, "What is the value of result?");
});
